              ...
              <div className="p-4 border-t border-border space-y-5 bg-surface/30">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button onClick={handleExportJson} className="flex items-center gap-2 p-2.5 bg-surface border border-border rounded-lg hover:border-accent hover:text-accent transition-all">
                      <FileJson size={16} />
